	...
	public void studentProgram() {
		...
		theEnd: while (true) {
			...
			case 5:
				...
				break;
			case 6:
				// DELETE FROM STUDENT-TBL WHERE STUDENT-ID = 'khuser01'
				studentId = inputStdId("삭제");
				result = controller.deleteStudent(studentId);
				break;
			case 9:
				// SELECT * FROM STUDENT_TBL WHERE STUDENT_ID = 'khuser01' AND STUDENT_PWD =
				// '1234'
...
//		student.setStudentId(studentId);
		Student student = new Student(studentId, studentPw, studentName, gender, age, email, address, hobby, hobby);
		return student;
	}
